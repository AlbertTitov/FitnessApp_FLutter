...
class WorkoutSchedule {
  ...
  WorkoutSchedule({ this.uid, this.author, this.title, this.description, this.weeks });
...
class WorkoutForTimeDrillBlock extends WorkoutDrillsBlock {
  ...
  WorkoutForTimeDrillBlock({ this.timeCapMin, this.rounds,
    this.restBetweenRoundsMin, List<WorkoutDrill> drills })
      : super(type: WorkoutDrillType.ForTime, drills: drills);

  WorkoutForTimeDrillBlock copy() {
    return WorkoutForTimeDrillBlock(timeCapMin: timeCapMin, rounds: rounds,
        restBetweenRoundsMin: restBetweenRoundsMin, drills: copyDrills());
  }
...
class WorkoutEmomDrillBlock extends WorkoutDrillsBlock {
  ...
  WorkoutEmomDrillBlock({ this.timeCapMin, this.intervalMin,
    List<WorkoutDrill> drills })
      : super(type: WorkoutDrillType.EMOM, drills: drills);

  WorkoutEmomDrillBlock copy() {
    return WorkoutEmomDrillBlock(timeCapMin: timeCapMin, intervalMin: intervalMin,
        drills: copyDrills());
  }
...
class WorkoutRestDrillBlock extends WorkoutDrillsBlock {
  ...
  WorkoutRestDrillBlock copy() {
    return WorkoutRestDrillBlock(timeMin: timeMin, drills: copyDrills());
  }
